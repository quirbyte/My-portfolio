...
export default function About() {
  const stats = [
    ...
    { label: "Commitment", value: "100% Remote" },
  ];
  ...
  return (
    <section
      id="about"
      className="min-h-screen w-full items-center flex justify-center relative bg-black text-white overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I turn complex ideas into seamless, high-performance digital
              realities. Engineering the perfect balance between robust backend
              architecture and elegant user interfaces, I build scalable
              software that prioritizes clean code and delightful user
              experiences.
            </p>
            <div className="mt-6 grid grid-cols-3 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {stats.map((item, i) => (
                <motion.div
                  key={i}
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
            I am a dedicated developer focused on building efficient, modern,
            and impactful solutions.
          </p>
          <p className="mt-4 text-gray-400 text-base sm:text-lg">
            Also crafting seamless digital experiences by blending technical
            precision with creative, user-centered design.
          </p>
        </motion.div>
      </div>
    </section>

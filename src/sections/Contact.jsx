          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            <div className="flex flex-col">
              ...
              <input
                ...
                className={`p-3 rounded-md bg-white/10 border ${errors.name ? "border-red-500" : "border-gray-500"} text-white focus:border-blue-500 focus:outline-none`}
              />
              {errors.name && (
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={handleChange}
                className={`p-3 rounded-md bg-white/10 border ${errors.email ? "border-red-500" : "border-gray-500"} text-white focus:border-blue-500 focus:outline-none`}
              />
              {errors.email && (
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                onChange={handleChange}
                className={`p-3 rounded-md bg-white/10 border ${errors.service ? "border-red-500" : "border-gray-500"} text-white focus:border-blue-500 focus:outline-none`}
              >
            ...
            {formData.service && formData.service !== "Others" && (
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className={`p-3 rounded-md bg-white/10 border ${errors.budget ? "border-red-500" : "border-gray-500"} text-white focus:border-blue-500 focus:outline-none`}
                />
                {errors.budget && (
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                value={formData.idea}
                onChange={handleChange}
                className={`p-3 rounded-md bg-white/10 border ${errors.idea ? "border-red-500" : "border-gray-500"} text-white focus:border-blue-500 focus:outline-none`}
              ></textarea>
              {errors.idea && (

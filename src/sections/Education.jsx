...
const experiences = [
  {
    institute: "K.E. Carmel School, Sarisha",
    degree: "ICSE Class 10th",
    duration: "2010-2022",
    description:
      "Learned & Worked on developing fundamental web and software applications using HTML, CSS, and Java.",
  },
  {
    institute: "Delhi Public School, Joka",
    degree: "CBSE Class 12th",
    duration: "2022-2024",
    description:
      "Built basic software solutions utilizing Python and MySQL logic.",
  },
  {
    institute: "KIIT, Bhubaneshwar",
    degree: "B.Tech in CSE(AI&ML)",
    duration: "2024-2028",
    description:
      "Engineering end-to-end software solutions that bridge low-level logic with modern, scalable web architectures.",
  },
];
  ...
  if (layout === "desktop") {
    return (
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        ...
        ></motion.div>
        <motion.article
          className={`absolute ${idx % 2 === 0 ? "bottom-12" : "top-12"} bg-gray-900/80 backdrop-blur border border-gray-700/70 rounded-xl p-7 w-80 shadow-lg`}
          style={{ opacity, y, maxWidth: "90vw" }}
          transition={{ duration: 0.4, delay: idx * 0.15 }}
        >
          <h3 className="text-xl font-semibold">{exp.institute}</h3>
          <p className="text-md text-gray-400 mb-3">
            {exp.degree} | {exp.duration}
          </p>
